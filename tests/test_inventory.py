...
class QmlContractCase(unittest.TestCase):
    def test_satellite_lifecycle_and_shared_tree_contract(self) -> None:
        ...
        self.assertIn('itemsKey: "definitions", healthBasis: "configuration-only"', service)
        self.assertIn('exactProject: false, scanArguments: ["--watch"]', service)
        self.assertIn('observers: Qt.binding(function() { return service.observers })', service)
